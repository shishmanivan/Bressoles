...
CARD_TOOLTIPS.update(
    {
        ...
        409: (
            "Momentum",
            "После случайного роста или падения акция повторяет то же движение ещё раз.",
        ),
        410: (
            "Uptrend",
        ...
        424: (
            "Volatility",
            "Увеличивает шаг роста и падения каждого рынка на 2.",
        ),
        425: (
            "Volatility+",
        ...
        434: (
            "Shareholder Base",
            "В конце раунда даёт 1 наполеондор за каждого Shareholder в колоде.",
        ),
    }
)
