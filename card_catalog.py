...
BLUE_CHIPS_CARD_ID = 22

CATALYST_CARD_ID = 210
CATALYST_PERCENTAGE_POINTS = 10
GOLD_CATALYST_CARD_ID = 414
GOLD_CATALYST_PERCENTAGE_POINTS = 15
GOLD_DISCLOSURE_CARD_ID = 427
GOLD_DISCLOSURE_PERCENTAGE_POINTS = 2
GOLD_FULL_DEPLOYMENT_CARD_ID = 428
GOLD_FULL_DEPLOYMENT_REWARD = 7
GOLD_ADVANCE_BASE_CHANCE = 15
GOLD_CONCENTRATION_CARD_ID = 429
GOLD_WATERLOO_CARD_ID = 430
GOLD_WATERLOO_BASE_CHANCE = 25
GOLD_RISK_PREMIUM_CARD_ID = 431
GOLD_SELLING_PRESSURE_CARD_ID = 432
GOLD_DOWNSIDE_RISK_CARD_ID = 433
GOLD_SHAREHOLDER_BASE_CARD_ID = 434
SILVER_CONCENTRATION_CARD_ID = 213
SILVER_NABOB_CARD_ID = 216
GOLD_UPTREND_PERCENT_PER_NAPOLEONDOR = 2
...
CATALYST_AFFECTED_CARD_IDS = frozenset({1, 2, 3, 4, 125, 215, 302, 401, 406, 407, 410, 413, 420, 430})
...
DROP_CARD_IDS = frozenset(
    card_id for card_id, spec in PRICE_CARD_SPECS.items() if spec.action < 0
)
...
SUPPORTED_CARD_IDS_BY_TYPE = {
    1: frozenset({1, 2, 3, 4, BLUE_CHIPS_CARD_ID}) | PRICE_CARD_IDS | REGULATION_CARD_IDS,
    2: frozenset({100, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 124, 125}),
    3: frozenset({201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220}),
    4: frozenset({301, 302, 303}),
    5: frozenset({401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416, 417, 418, 419, 420, 421, 422, 423, 424, 425, 426, 427, 428, 429, 430, 431, 432, 433, 434}),
}
