...
LICENSE_EFFECT_DESCRIPTIONS = {
    ...
    125: "Можно сыграть только на последнем игровом ходу. С шансом 50% удваивает цены акций, которыми владеет игрок. Catalyst повышает этот шанс.",
    126: "Если игрок владеет акциями C и цена C упала в этом ходу, сразу даёт 4 акции A. При срабатывании карта подпрыгивает.",
    118: "Устанавливает цены всех акций на 10.",
    119: "Устанавливает цены всех акций на 20.",
    120: "Устанавливает цены всех акций на 30.",
    121: "Устанавливает цены всех акций на 50.",
    ...
    210: "Усиливает числовые процентные эффекты карт на 10 процентных пунктов, сохраняя полезное направление эффекта.",
